...
const BottomNavigation = () => {
  ...
  return (
    <div
      ...
      className="border-cultured shadow-normal xs:rounded-t-lg fixed bottom-0 left-1/2 z-10 flex w-full max-w-[500px] -translate-x-1/2 justify-around border-t-[1px] bg-white py-[5px] lg:hidden"
    >
